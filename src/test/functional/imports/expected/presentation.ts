...
import { SpreadsheetModel, CompleteSpreadsheet, RelatedSpreadsheetModel } from "./index"
...
export const SimpleRelatedPresentationModel = {
  spreadsheets: { shape: { SpreadsheetModel }, array: true },
}
