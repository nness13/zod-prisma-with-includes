...
import { PresentationModel, CompletePresentation, RelatedPresentationModel } from "./index"
...
export const SimpleRelatedSpreadsheetModel = {
  presentations: { shape: { PresentationModel }, array: true },
}
